...
class Order(BaseModel):
    ...
    total_amount: float
    created_at: datetime
    items: List[dict]  # Assuming items is a list of product details
...
async def get_orders():
    try:
        ...
        # If you need to transform results to your desired output format
        orders = [
            {
                "id": row["id"],
...
# Make sure to include this router in your main application file