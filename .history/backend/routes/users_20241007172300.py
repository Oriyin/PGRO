...
async def login_user(user: UserLogin):
    ...
    # Convert created_at and last_login to Thailand time
    last_login_thai = utc_to_thai_time(datetime.utcnow())
    
    return {
        "user_id": db_user['user_id'],
        "username": db_user['username'],
        "email": db_user['email'],
        "created_at": utc_to_thai_time(db_user['created_at']),  # Convert to Thai time
        "last_login": last_login_thai  # Return last_login in Thai time
    }