...
# 1. Endpoint to get the latest logged-in users - DECLARE THIS FIRST
...
# 4. Endpoint to get a user by user_id - DECLARE THIS LAST
...
async def update_last_login(user_id: int):
    ...
    """
    values = {"last_login": datetime.now(), "user_id": user_id}
