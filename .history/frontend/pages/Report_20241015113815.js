...
const Report = () => {
  const [salesData, setSalesData] = useState(null);  // Initially null to detect loading
  ...
  useEffect(() => {
    ...
    // Fetch both sales data and weekly report
    Promise.all([fetchSalesData(), fetchWeeklyReport()]).finally(() => {
      setLoading(false);  // Only stop loading once both requests are finished
    });
  }, []);
  ...
  // Return early if salesData or weeklyReport is still null
  if (!salesData || !weeklyReport) {
            ...
            <Paper elevation={3} sx={{ padding: '20px', backgroundColor: colors.lightPurple }}>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={salesData}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="sales" fill={colors.purple} />
                </BarChart>
              </ResponsiveContainer>
            </Paper>
          </Grid>
                ...
                <Gauge
                  ...
                  sx={{
                    ...
                    [`& .${gaugeClasses.valueArc}`]: {
                      fill: colors.darkPurple,  // Dark purple arc for sales performance
                    },
                    [`& .${gaugeClasses.referenceArc}`]: {
                      fill: colors.grey,  // Grey for the remaining arc
                    },
                  }}
                />
              ...
              <Box sx={{ width: '100%', height: 300 }}>
                <Gauge
                  ...
                  sx={{
                    ...
                    [`& .${gaugeClasses.valueArc}`]: {
                      fill: colors.purple,  // Purple arc for orders performance
                    },
                    [`& .${gaugeClasses.referenceArc}`]: {
                      fill: colors.grey,  // Grey for the remaining arc
                    },
