                ...
                <Grid item xs={12}>
                    <Box border={1} borderColor="#004d40" borderRadius="8px" padding={2} bgcolor="#ffffff" boxShadow={3} textAlign="center">
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1" color="textSecondary">
                                    <strong>Facebook:</strong> <a href="https://www.facebook.com/KMITL.RoboticsAI/" target="_blank" rel="noopener noreferrer">facebook.com/yourstore</a>
                                </Typography>
                                <Typography variant="body1" color="textSecondary">
                                    <strong>Instagram:</strong> <a href="https://www.instagram.com/raikmitl.official/" target="_blank" rel="noopener noreferrer">@yourstore</a>
                                </Typography>
                            </Grid>
                        </Grid>
                    </Box>
