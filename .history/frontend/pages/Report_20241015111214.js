                ...
                <Gauge
                  ...
                  sx={{
                    ...
                    [`& .${gaugeClasses.valueArc}`]: {
                      fill: colors.green,  // Green arc for sales performance
                    },
                    [`& .${gaugeClasses.referenceArc}`]: {
                      fill: '#ddd',  // Grey for the remaining arc
                    },
                  }}
                />
          ...
          <Grid item xs={12} lg={6}>
            <Paper elevation={3} sx={{ padding: '20px', backgroundColor: colors.lightPurple }}>
              ...
              <Box sx={{ width: '100%', height: 300 }}>
                <Gauge
                  ...
                  sx={{
                    ...
                    [`& .${gaugeClasses.valueText}`]: {
                      fontSize: '24px',
                      fontWeight: 'bold',
                      fill: colors.orange,  // Orange text for better visibility
                    },
                    [`& .${gaugeClasses.valueArc}`]: {
                      fill: colors.orange,  // Orange arc for orders performance
                    },
                    [`& .${gaugeClasses.referenceArc}`]: {
                      fill: '#ddd',  // Grey for the remaining arc
                    },
                ...
                />
                <Typography variant="body2" color={colors.orange} textAlign="center">
