...
const Dashboard = () => {
  ...
  const [recentLogins, setRecentLogins] = useState([]); // State for recent logins
  ...
  useEffect(() => {
    ...
    const fetchRecentLogins = async () => {
      ...
      const data = await response.json();
      setRecentLogins(data); // Store the recent logins
    };
    ...
    const fetchData = async () => {
      ...
      await fetchRecentLogins(); // Fetch recent logins
      setLoading(false);
    };
