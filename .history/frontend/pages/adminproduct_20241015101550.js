...
import AdminNavbar from '../components/AdminNavbar'; // นำเข้า AdminNavbar
...
const ProductTable = () => {
    ...
    return (
        <div style={{ backgroundColor: '#82CAFF', height: '100vh', padding: '20px' }}>
            <AdminNavbar /> {/* เพิ่ม AdminNavbar ที่นี่ */}
            <TableContainer component={Paper} style={{ marginTop: '20px' }}> {/* เพิ่ม marginTop เพื่อไม่ให้ทับกัน */}
                <Table>
                    <TableHead>
                        <TableRow>
                        ...
                        {loading ? (
                            ...
                            products.map(product => (
                                <TableRow key={product.id}>
                                    ...
                                    <TableCell>
                                        {/* แสดง 'Out of Stock' เมื่อ quantity เท่ากับ 0 หรือน้อยกว่า */}
