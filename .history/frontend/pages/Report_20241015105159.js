...
const Report = () => {
  ...
  useEffect(() => {
    ...
    const fetchWeeklyReport = async () => {
      try {
        const weeklyResponse = await fetch('/api/weekly-report');
            ...
            <Paper elevation={3} sx={{ padding: '20px', backgroundColor: colors.lightPurple }}>
              ...
              <Box display="flex" justifyContent="center" alignItems="center">
                ...
                <Box sx={{ marginRight: 4 }}>
                  <Typography variant="subtitle1" gutterBottom color={colors.purple} align="center">
                    Total Sales
                  </Typography>
                  <Gauge
                ...
                <Box>
                  ...
                  <Gauge
                    ...
                    max={1000}  {/* Adjust this max value based on your actual total orders range */}
                    startAngle={0}
                    endAngle={360}
                    innerRadius="80%"
                    outerRadius="100%"
