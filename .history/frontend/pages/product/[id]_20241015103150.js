            ...
            <Dialog open={open} onClose={() => setOpen(false)}>
                ...
                <DialogContent>
                    ...
                    <TextField 
                        ...
                        fullWidth 
                        value={quantity} 
                        onChange={(e) => setQuantity(Math.max(1, Math.min(Number(e.target.value), product.quantity)))} // Set max to product quantity
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleConfirmAddToCart} color="primary" disabled={product.quantity <= 0}>Confirm</Button>
                </DialogActions>
            </Dialog>
        </>
    );
