                ...
                <Grid item xs={12} md={8}>
                    ...
                    >
                        ...
                        <Grid container spacing={3} justifyContent="center">
                            ...
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1" color="textSecondary" style={{ fontSize: '16px' }}>
                                    <strong>Facebook:</strong> <a href="https://www.facebook.com/KMITL.RoboticsAI/" target="_blank" rel="noopener noreferrer" style={{ color: '#1a237e' }}>facebook.com/yourstore</a>
                                </Typography>
                                <Typography variant="body1" color="textSecondary" style={{ fontSize: '16px' }}>
                                    <strong>Instagram:</strong> <a href="https://www.instagram.com/raikmitl.official/" target="_blank" rel="noopener noreferrer" style={{ color: '#1a237e' }}>@yourstore</a>
                                </Typography>
                            </Grid>
                        </Grid>
                    </Box>
