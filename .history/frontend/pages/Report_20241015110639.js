...
const Report = () => {
  ...
  return (
    <>
      <AdminNavbar />
      <Box sx={{ padding: '90px', backgroundColor: colors.lightGray }}>
        <Typography variant="h4" gutterBottom color={colors.darkPurple} fontWeight="bold">
          Sales Report
        </Typography>
        <Grid container spacing={4}>
          {/* Enhanced Sales Line Chart */}
          <Grid item xs={12} lg={8}>
            <Paper elevation={4} sx={{ padding: '30px', backgroundColor: colors.white, borderRadius: '16px' }}>
              <Typography variant="h6" gutterBottom color={colors.purple} fontWeight="bold">
          ...
          {/* Gauge Chart: Weekly Sales Performance */}
          <Grid item xs={12} lg={6}>
            <Paper elevation={4} sx={{ padding: '30px', backgroundColor: colors.lightPurple, borderRadius: '16px' }}>
              <Typography variant="h6" gutterBottom color={colors.darkPurple} fontWeight="bold" textAlign="center">
              ...
              <Typography variant="body2" color={colors.purple} textAlign="center" mt={2}>
                Target: ฿500 / Week
              </Typography>
            </Paper>
          </Grid>

          {/* Gauge Chart: Weekly Orders Performance */}
          <Grid item xs={12} lg={6}>
            <Paper elevation={4} sx={{ padding: '30px', backgroundColor: colors.lightPurple, borderRadius: '16px' }}>
              <Typography variant="h6" gutterBottom color={colors.darkPurple} fontWeight="bold" textAlign="center">
